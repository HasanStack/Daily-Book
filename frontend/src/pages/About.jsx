  ...
  return (
    <div className="flex justify-center px-4 sm:px-6 lg:px-10 my-10">
      <div className="w-full max-w-3xl bg-base-200 shadow-xl hover:shadow-2xl rounded-3xl p-6 md:p-8">
        <h1 className="text-3xl font-bold text-center mb-7">About DailyBook</h1>
        <p className="text-lg text-center mb-4">
          DailyBook is a secure and trusted digital journal that protects your
        ...
        <ul className="space-y-3 text-lg px-4 sm:px-6">
          <li className="flex items-start gap-2">
            ...
            <span>
              ...
              edit, and delete dailybook entries while keeping them safe.
            </span>
          </li>
          <li className="flex items-start gap-2">
            <span>📅</span>
        ...
        <p className="text-lg text-center">
          Start your journaling journey with <strong>DailyBook</strong> - where
